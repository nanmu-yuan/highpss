<template>
  <div>
    <div v-for="(item, index) in subjectList" :key="index">
      ...
      <!-- 选项 -->
      <div class="test_item" :class="(val[index] == 'a' && item.state) || answer[index] == 'a' ? 'current' : ''" @click="decideOn('a', index)" style="position: relative">
        <div class="fl" :class="{ sure: correct[index] == 'a', error: item.errorAnswer == 'a' && item.error }">
          <p>A.</p>
        </div>
      ...
      <div class="test_item" :class="(val[index] == 'b' && item.state) || answer[index] == 'b' ? 'current' : ''" @click="decideOn('b', index)">
      ...
      <div class="test_item" :class="(val[index] == 'c' && item.state) || answer[index] == 'c' ? 'current' : ''" @click="decideOn('c', index)">
