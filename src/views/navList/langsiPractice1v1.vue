  ...
  <div class="box">
    ...
    <div class="contion">
      ...
      <div class="course_introduce">
        <langsi-courselvl :info="course"></langsi-courselvl>
...
import langsiCourselvl from '@/components/langsi/course1v1.vue'
...
export default {
    ...
    return {
      ...
      pirce: {
        ...
        videopirce: [
          // {
          //   textwei: '朗思课程 > 朗思写作',
          //   img1: require('@/assets/image/langsi/pirce_video2.png'),
          //   title: '朗思写作训练营',
          //   hour: '18',
          //   duration1: '1',
          //   duration2: '10',
  ...
  methods: {
    //获取课程
    getCoursetype() {
      this.$api.getCoursetype('朗思全科1V1').then((res) => {
